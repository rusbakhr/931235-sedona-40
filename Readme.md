...
* Ссылка на опубликованный проект: [Седона](https://rusbakhr.github.io/931235-sedona-40/)
...
[Откройте мастер-репозиторий](https://github.com/htmlacademy-htmlcss/931235-sedona-40) и нажмите кнопку «Fork» в правом верхнем углу. Репозиторий из Академии скопируется в ваш аккаунт.
